...
```
git clone https://github.com/this-is-you/gomerce_user_fe.git
```
...
- ### Authentication Error
  ...
  fatal: Authentication failed for 'https://github.com/<your-username>/gomerce_user_fe.git/'</pre>
...
shall be the agreed source code from the team working together [instruction](https://github.com/Ajioz/gomerce_user_fe/blob/main/README.md).
